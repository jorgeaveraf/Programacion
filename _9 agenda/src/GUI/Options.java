...
public class Options extends JFrame {
    ...
    private void etiquetasTop(){
        JLabel titulo = new JLabel("Contacts", SwingConstants.CENTER);
    ...
    private void etiquetasCentro(){
        ...
        nClient.setText("<html><center>REGISTER A<br>NEW CONTACT</center></html>");
        ...
        eClient.setText("<html><center>VERIFY AN<br>EXISTENT CONTACT</center></html>");
    ...
    private void listener(){
        nClient.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                nContact nContact1 = new nContact();
                nContact1.setVisible(true);
                setVisible(false);
            }
        });
