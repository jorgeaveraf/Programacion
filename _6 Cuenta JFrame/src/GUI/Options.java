...
public class Options extends JFrame {
    ...
    private void etiquetasTop(){
        JLabel titulo = new JLabel("Ccuenta", SwingConstants.CENTER);
    ...
    private void etiquetasCentro(){
        ...
        nClient.setText("<html><center>REGISTER A<br>NEW CLIENT</center></html>");
        ...
        eClient.setText("<html><center>VERIFY AN<br>EXISTENT CLIENT</center></html>");
