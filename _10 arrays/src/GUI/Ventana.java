...
public class Ventana extends JFrame {
    ...
    private void etiquetasTop(){
        JLabel titulo = new JLabel("Array", SwingConstants.CENTER);
        ...
        JLabel subtitulo = new JLabel("Tipo Char", SwingConstants.CENTER);
    ...
    private void etiquetasBottom(){
        JLabel terms = new JLabel("Verificador de cadenas", SwingConstants.CENTER);
        ...
        JLabel forgot = new JLabel("", SwingConstants.CENTER);
    ...
    private void listener(){
        enter.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String v="diferentes";
                Validador array = new Validador();
                if (array.validate(c1,c2) == true){
                    v="iguales";
                }
                JOptionPane.showMessageDialog(null,"Las cadenas son: "+v);
                System.out.println(array.validate(c1,c2));
            }
        });
