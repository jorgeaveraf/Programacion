...
public class eContact extends JFrame {
    ...
    public eContact() {
        ...
        logicAgenda = LogicAgenda.getInstance();
        componentes();
    }
    ...
    public void actualizarNombre () {
        ...
        c = logicAgenda.buscarContactoPorTelefono(accountLong) ;
        if (c != null) {
            String cumple = "";
    ...
    public void dListener(){
        ...
        enter.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                long accountLong = Long.parseLong(cuenta);
                        ...
                        switch (item) {
                            case "Name":
                                logicAgenda.setName(logicAgenda.index(accountLong),tModify.getText());
                                break;
                            case "Cellphone":
                                logicAgenda.setTelefono(logicAgenda.index(accountLong), Long.valueOf(tModify.getText()));
                                break;
                            case "Email":
                                logicAgenda.setEmail(logicAgenda.index(accountLong),tModify.getText());
                                break;
                            case "Birthday":
                                logicAgenda.setCumple(logicAgenda.index(accountLong), LocalDate.parse(tModify.getText()));
                                break;
                        }
                        actualizarNombre();
                        }
        ...
        enter2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (item) {
                    case "Name":
                        logicAgenda.setName(logicAgenda.index(accountLong),"");
                        break;
                    case "Email":
                        logicAgenda.setEmail(logicAgenda.index(accountLong),"");
                        break;
                    case "Birthday":
                        logicAgenda.setCumple(logicAgenda.index(accountLong), null);
                        break;
                    case "Contact":
                        logicAgenda.setContacto(logicAgenda.index(accountLong));
                        break;
                }
                actualizarNombre();
                    }
